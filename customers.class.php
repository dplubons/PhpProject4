...
class Customer { 
    ...
    function read_record($id) { // display "read" form
        ...
        $this->generate_html_top(2);
				...
				<div class='control-group col-md-6'>
					...
					"; 
					if ($this->fileSize > 0) {
						$source = ' https://csis.svsu.edu/~dplubons/cis355/PhpProject4/uploads/';
    ...
    function update_db_record ($id) {
		...
		$this->path ='/home/dplubons/public_html/cis355/PhpProject4/uploads/' . $this->fileName;
				...
				if ($this->fieldsAllValid()) {
					...
					echo " 
						<div class='form-actions'>
							...
							<a href='https://csis.svsu.edu/~dplubons/cis355/PhpProject4/uploads' target='_blank'>Uploaded Pictures</a><br />";
					...
					foreach ($pdo->query($sql) as $row) {
						...
						if($temp != "") {
							...
							$path = '/home/dplubons/public_html/cis355/PhpProject4/uploads/' . $row['fileName'];
    ...
    function list_records() {
        ...
        echo "
            ...
            <body>
                <a href='https://github.com/dplubons/PhpProject4' target='_blank'>Github Repo</a><br />
                <a href='https://csis.svsu.edu/~dplubons/cis355/PhpProject4/CIS_355_P4_UML.pdf' target='_blank'>Diagram</a><br />
                <a href='https://csis.svsu.edu/~dplubons/cis355/PhpProject4/CIS355_DiagramProject4.pdf' target='_blank'>FlowChart</a><br />
				<a href='https://csis.svsu.edu/~dplubons/cis355/PhpProject4/uploads' target='_blank'>Uploaded Pictures</a><br />
